...
from tools import search_tool, ReadFinancialDocumentTool
...
financial_analyst = Agent(
    ...
    goal=(
        "Analyze the provided financial document and answer the user query: {query}. "
        "All insights must be strictly based on the document content."
    ),
    verbose=True,
    memory=True,
    backstory=(
    ...
    tools=[read_financial_document_tool, search_tool],
    llm=llm,
    max_iter=1,
    max_rpm=1,
